...
public class Main {
    ...
    // This code checks if the given string is non-empty, contains at least
    ...
    public static boolean checkForPassword(String str, int minLength) {
        ...
        String regex = String.format("^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d).{%d,}$", minLength);
    ...
    // This method returns a list of all email addresses contained in the
    ...
    public static List<String> extractEmails(String str) {
        ...
        // String regex = "^.+@(?:mail.utoronto.ca|utoronto.ca)$";
        String regex = "\\b[A-Za-z0-9._%+-]+@(mail\\.utoronto\\.ca|utoronto\\.ca)\\b";
